...
public class TrainModuleUtils {
    ...
    private static Map<String, String> getLayerInfo(NeuralNetConfiguration c, Layer layer) {
        ...
        if (layer instanceof ConvolutionLayer) {
        	deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.ConvolutionLayer layer1 = (deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.ConvolutionLayer) layer;
