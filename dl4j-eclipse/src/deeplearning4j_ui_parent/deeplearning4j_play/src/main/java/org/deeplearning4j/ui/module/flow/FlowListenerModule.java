package deeplearning4j_ui_parent.deeplearning4j_play.src.main.java.org.deeplearning4j.ui.module.flow;
...
public class FlowListenerModule implements UIModule {
    ...
    public List<Route> getRoutes() {
        Route r1 = new Route("/flow", HttpMethod.GET, FunctionType.Supplier, () -> ok(deeplearning4j_ui_parent.deeplearning4j_ui_model.src.main.java.org.deeplearning4j.ui.views.html.flow.Flow.apply()));
    ...
    private Result getStaticInfo(String sessionID){
        ...
        if(!(p instanceof FlowStaticPersistable)) return ok();
    ...
    private Result getUpdate(String sessionID){
        ...
        Persistable p = list.get(0);
        if(!(p instanceof FlowUpdatePersistable)) return ok();
