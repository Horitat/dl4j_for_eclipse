package deeplearning4j_nlp_parent.deeplearning4j_nlp.src.test.java.org.deeplearning4j.models.embeddings.inmemory;
...
public class InMemoryLookupTableTest {
    ...
    public void testConsumeOnNonEqualVocabs() throws Exception {
        ...
        //self made
        assertTrue(mem1.getSyn0().rows() < mem2.getSyn0().rows());
//        assertTrue(mem1.syn0.rows() < mem2.syn0.rows());

        assertEquals(mem1.getSyn0().rows() + 3, mem2.getSyn0().rows());
