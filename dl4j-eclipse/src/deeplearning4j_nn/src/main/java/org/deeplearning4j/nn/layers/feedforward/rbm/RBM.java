...
package deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.feedforward.rbm;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.BasePretrainNetwork;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.util.RBMUtil;
 ...
 *
 */
public  class RBM extends BasePretrainNetwork<deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.RBM> {
...
//        INDArray chainStart = probHidden.getSecond();
    ...
    public void iterate(INDArray input) {
        if(layerConf().getVisibleUnit() == deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.RBM.VisibleUnit.GAUSSIAN)
    ...
    public Layer transpose() {
        ...
        deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.RBM.HiddenUnit h = RBMUtil.inverse(layerConf().getVisibleUnit());
        deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.RBM.VisibleUnit v = RBMUtil.inverse(layerConf().getHiddenUnit());
        if(h == null)
