...
public class GlobalPoolingLayer extends Layer {
    ...
    public deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.api.Layer instantiate(NeuralNetConfiguration conf, Collection<IterationListener> iterationListeners, int layerIndex, INDArray layerParamsView, boolean initializeParams) {
    	deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.pooling.GlobalPoolingLayer ret = new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.pooling.GlobalPoolingLayer(conf);
