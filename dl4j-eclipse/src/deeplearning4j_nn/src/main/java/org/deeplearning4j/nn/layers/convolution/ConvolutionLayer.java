...
package deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.convolution;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.params.ConvolutionParamInitializer;
 ...
 */
public class ConvolutionLayer extends BaseLayer<deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.ConvolutionLayer> {
    ...
    public ConvolutionLayer(NeuralNetConfiguration conf) {
        super(conf);
        initializeHelper();
        convolutionMode = ((deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.ConvolutionLayer)conf().getLayer()).getConvolutionMode();
    }
