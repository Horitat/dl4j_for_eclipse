...
package deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.graph;
...
public class ElementWiseVertex extends GraphVertex {
    ...
    public deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.graph.vertex.GraphVertex instantiate(ComputationGraph graph, String name, int idx,
    	...
    	deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.graph.vertex.impl.ElementWiseVertex.Op op;
        switch(this.op){
            case Add:
                op = deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.graph.vertex.impl.ElementWiseVertex.Op.Add;
                break;
            case Subtract:
                op = deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.graph.vertex.impl.ElementWiseVertex.Op.Subtract;
                break;
            case Product:
                op = deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.graph.vertex.impl.ElementWiseVertex.Op.Product;
                break;
            default:
                throw new RuntimeException();
        }
        return new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.graph.vertex.impl.ElementWiseVertex(graph,name,idx,op);
    }
