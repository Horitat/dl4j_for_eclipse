...
public class LayerVertex extends GraphVertex {
    ...
    public deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.graph.vertex.GraphVertex instantiate(ComputationGraph graph, String name, int idx,
        ...
        deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.api.Layer layer = layerConf.getLayer().instantiate(layerConf, null, idx, paramsView, initializeParams);

        return new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.graph.vertex.impl.LayerVertex(graph, name, idx, layer, preProcessor, isOutput);
    }
