package deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.variational;
...
import static deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.params.VariationalAutoencoderParamInitializer.*;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.params.VariationalAutoencoderParamInitializer;
...
public class VariationalAutoencoder implements Layer {
    ...
    public VariationalAutoencoder(NeuralNetConfiguration conf) {
        ...
        this.encoderLayerSizes = ((deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.variational.VariationalAutoencoder) conf.getLayer()).getEncoderLayerSizes();
        this.decoderLayerSizes = ((deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.variational.VariationalAutoencoder) conf.getLayer()).getDecoderLayerSizes();
        this.reconstructionDistribution = ((deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.variational.VariationalAutoencoder) conf.getLayer()).getOutputDistribution();
        this.pzxActivationFn = ((deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.variational.VariationalAutoencoder) conf.getLayer()).getPzxActivationFn();
        this.numSamples = ((deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.variational.VariationalAutoencoder) conf.getLayer()).getNumSamples();
    }
