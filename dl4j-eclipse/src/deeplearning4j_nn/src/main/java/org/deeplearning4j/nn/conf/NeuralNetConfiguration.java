...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.stepfunctions.StepFunction;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.weights.WeightInit;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.util.reflections.DL4JSubTypesScanner;
...
public class NeuralNetConfiguration implements Serializable,Cloneable {
    ...
    public static class Builder implements Cloneable {
        ...
        private void learningRateValidation(String layerName){
            ...
            if (!Double.isNaN(lrPolicySteps) && (learningRatePolicy != LearningRatePolicy.Step && learningRatePolicy != LearningRatePolicy.Sigmoid && learningRatePolicy != LearningRatePolicy.TorchStep))
