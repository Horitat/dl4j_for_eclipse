...
public class DefaultParamInitializer implements ParamInitializer {
    ...
    public int numParams(NeuralNetConfiguration conf) {
    	deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.FeedForwardLayer layerConf =
                (deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.FeedForwardLayer) conf.getLayer();
