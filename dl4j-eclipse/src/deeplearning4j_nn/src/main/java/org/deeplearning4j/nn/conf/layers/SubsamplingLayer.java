...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.api.ParamInitializer;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.ConvolutionMode;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.params.EmptyParamInitializer;
...
public class SubsamplingLayer extends Layer {
    ...
    protected deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.PoolingType poolingType;
    ...
    public enum PoolingType {
        ...
        public deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.PoolingType toPoolingType(){
            switch (this){
                case MAX:
                    return deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.PoolingType.MAX;
                case AVG:
                    return deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.PoolingType.AVG;
                case SUM:
                    return deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.PoolingType.SUM;
                case PNORM:
                    return deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.PoolingType.PNORM;
                case NONE:
                    return deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.PoolingType.NONE;
            }
    ...
    @Override
    public deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.api.Layer instantiate(NeuralNetConfiguration conf, Collection<IterationListener> iterationListeners, int layerIndex, INDArray layerParamsView, boolean initializeParams) {
    	deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.convolution.subsampling.SubsamplingLayer ret
                = new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.convolution.subsampling.SubsamplingLayer(conf);
    ...
    public static class Builder extends Layer.Builder<Builder> {
        private deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.PoolingType poolingType
        = deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.PoolingType.MAX;
        ...
        public Builder(deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.PoolingType poolingType, int[] kernelSize) {
            this.poolingType = poolingType;
            this.kernelSize = kernelSize;
        }

        public Builder(deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.PoolingType poolingType, int[] kernelSize, int[] stride, int[] padding){
            this.poolingType = poolingType;
            this.kernelSize = kernelSize;
            this.stride = stride;
            this.padding = padding;
        ...
        public Builder(deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.PoolingType poolingType){
            this.poolingType = poolingType;
        }
        ...
        public SubsamplingLayer build() {
            if(poolingType==deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.PoolingType.PNORM && pnorm <= 0) throw new IllegalStateException("Incorrect Subsampling config: p-norm must be set when using PoolingType.PNORM");
