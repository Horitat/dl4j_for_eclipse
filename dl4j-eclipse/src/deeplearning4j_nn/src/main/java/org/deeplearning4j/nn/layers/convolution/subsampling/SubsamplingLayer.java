...
package deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.convolution.subsampling;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.PoolingType;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.util.ConvolutionUtils;
 ...
 */
@Slf4j
public class SubsamplingLayer extends BaseLayer<deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.SubsamplingLayer> {
    ...
    public SubsamplingLayer(NeuralNetConfiguration conf) {
        super(conf);
        initializeHelper();
        this.convolutionMode = ((deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.SubsamplingLayer)conf.getLayer()).getConvolutionMode();
    }
