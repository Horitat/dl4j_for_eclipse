 ...
 */
public class LocalResponseNormalization extends BaseLayer<deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.LocalResponseNormalization> {
    protected static final Logger log = LoggerFactory.getLogger(deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.LocalResponseNormalization.class);
