...
package deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.graph.rnn;
...
public class LastTimeStepVertex extends GraphVertex {
    ...
    @Override
    public deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.graph.vertex.impl.rnn.LastTimeStepVertex instantiate(ComputationGraph graph, String name, int idx,
                                                                                      INDArray paramsView, boolean initializeParams) {
        return new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.graph.vertex.impl.rnn.LastTimeStepVertex(graph,name,idx,maskArrayInputName);
    }
