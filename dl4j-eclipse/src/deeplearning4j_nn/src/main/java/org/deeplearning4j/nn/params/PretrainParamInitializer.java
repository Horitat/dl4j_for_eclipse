...
public class PretrainParamInitializer extends DefaultParamInitializer {
    ...
    public int numParams(NeuralNetConfiguration conf){
    	deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.BasePretrainNetwork layerConf =
                (deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.BasePretrainNetwork) conf.getLayer();
