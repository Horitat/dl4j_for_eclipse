...
public class GravesLSTMParamInitializer implements ParamInitializer {
    ...
    public int numParams(NeuralNetConfiguration conf) {
    	deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesLSTM layerConf =
                (deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesLSTM) conf.getLayer();
    ...
    public Map<String, INDArray> getGradientsFromFlattened(NeuralNetConfiguration conf, INDArray gradientView) {
    	deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesLSTM layerConf = (deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesLSTM) conf.getLayer();
