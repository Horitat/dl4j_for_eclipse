...
public class RBM extends BasePretrainNetwork {
    ...
    public Layer instantiate(NeuralNetConfiguration conf, Collection<IterationListener> iterationListeners, int layerIndex, INDArray layerParamsView, boolean initializeParams) {
    	deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.feedforward.rbm.RBM ret
                = new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.feedforward.rbm.RBM(conf);
