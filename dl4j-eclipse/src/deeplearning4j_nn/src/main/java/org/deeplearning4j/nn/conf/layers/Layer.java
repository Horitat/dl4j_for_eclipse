...
public abstract class Layer implements Serializable, Cloneable {
    ...
    public abstract deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.api.Layer
    instantiate(NeuralNetConfiguration conf, Collection<IterationListener> iterationListeners, int layerIndex,
