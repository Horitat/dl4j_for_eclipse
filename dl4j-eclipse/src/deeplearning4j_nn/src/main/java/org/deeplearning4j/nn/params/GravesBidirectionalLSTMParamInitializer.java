...
package deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.params;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.distribution.Distributions;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.weights.WeightInitUtil;
...
public class GravesBidirectionalLSTMParamInitializer implements ParamInitializer {
    ...
    public int numParams(NeuralNetConfiguration conf) {
    	deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesBidirectionalLSTM layerConf =
                (deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesBidirectionalLSTM) conf.getLayer();
    ...
    public Map<String, INDArray> getGradientsFromFlattened(NeuralNetConfiguration conf, INDArray gradientView) {
    	deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesBidirectionalLSTM layerConf = (deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesBidirectionalLSTM) conf.getLayer();
