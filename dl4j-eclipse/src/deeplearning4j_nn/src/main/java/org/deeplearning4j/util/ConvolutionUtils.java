...
package deeplearning4j_nn.src.main.java.org.deeplearning4j.util;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.exception.DL4JInvalidConfigException;
...
public class ConvolutionUtils {
    ...
    public static int[] getHeightAndWidth(NeuralNetConfiguration conf) {
        return getHeightAndWidth(((deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.ConvolutionLayer) conf.getLayer()).getKernelSize());
    }
    ...
    public static int numFeatureMap(NeuralNetConfiguration conf) {
        return ((deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.ConvolutionLayer) conf.getLayer()).getNOut();
    }
