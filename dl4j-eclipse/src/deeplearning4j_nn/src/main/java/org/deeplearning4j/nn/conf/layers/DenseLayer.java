...
public class DenseLayer extends FeedForwardLayer {
    ...
    public Layer instantiate(NeuralNetConfiguration conf, Collection<IterationListener> iterationListeners, int layerIndex,
        ...
        deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.feedforward.dense.DenseLayer ret
                = new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.feedforward.dense.DenseLayer(conf);
