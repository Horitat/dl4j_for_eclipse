...
//        this.convolutionType = builder.convolutionType;
    ...
    public Layer instantiate(NeuralNetConfiguration conf, Collection<IterationListener> iterationListeners, int layerIndex, INDArray layerParamsView, boolean initializeParams) {
        ...
        deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.convolution.ConvolutionLayer ret
                = new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.convolution.ConvolutionLayer(conf);
