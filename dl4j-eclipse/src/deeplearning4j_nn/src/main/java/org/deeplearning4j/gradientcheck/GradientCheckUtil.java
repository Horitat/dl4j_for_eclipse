package deeplearning4j_nn.src.main.java.org.deeplearning4j.gradientcheck;
...
public class GradientCheckUtil {
    ...
    public static boolean checkGradients( MultiLayerNetwork mln, double epsilon, double maxRelError, double minAbsoluteError,
        ...
        for(NeuralNetConfiguration n : mln.getLayerWiseConfigurations().getConfs()){
        	deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater u = n.getLayer().getUpdater();
            if(u == deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater.SGD){
                //Must have LR of 1.0
            ...
            } else if( u != deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater.NONE ){
    ...
    public static boolean checkGradients( ComputationGraph graph, double epsilon, double maxRelError, double minAbsoluteError,
        ...
        for(String vertexName : graph.getConfiguration().getVertices().keySet()){
            ...
            deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater u = lv.getLayerConf().getLayer().getUpdater();
            if(u == deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater.SGD){
                //Must have LR of 1.0
