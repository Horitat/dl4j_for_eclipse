...
package deeplearning4j_scaleout.spark.dl4j_spark.src.test.java.org.deeplearning4j.spark.impl.layer;
...
import deeplearning4j_scaleout.spark.dl4j_spark.src.main.java.org.deeplearning4j.spark.impl.layer.SparkDl4jLayer;
...
public class TestSparkLayer extends BaseSparkTest {
    ...
    public void testIris2() throws Exception {
        NeuralNetConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .iterations(10)
                .learningRate(1e-1)
                .layer(new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.OutputLayer.Builder(LossFunctions.LossFunction.MCXENT)
                        .nIn(4).nOut(3)
