package deeplearning4j_cuda.src.test.java.org.deeplearning4j.convolution;
...
public class TestConvolution {
    ...
    public void testSameModeActivationSizes(){
        ...
        deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.Layer[] l = new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.Layer[2];
    ...
    public void testCompareCudnnStandardOutputsVsMode() throws Exception {
        ...
        for(ConvolutionMode c : cm ) {
            for( boolean conv : new boolean[]{true,false}) {
            	...
            	deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.Layer l;
                if(conv){
