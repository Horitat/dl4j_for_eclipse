...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.preprocessor.CnnToRnnPreProcessor;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.preprocessor.ComposableInputPreProcessor;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.preprocessor.RnnToCnnPreProcessor;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.preprocessor.RnnToFeedForwardPreProcessor;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.convolution.ConvolutionLayer;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.feedforward.dense.DenseLayer;
    ...
    public void testRnnToFeedForwardPreProcessor() {
        ...
        for (int x = 0; x < miniBatchSizes.length; x++) {
            ...
            NeuralNetConfiguration nnc = new NeuralNetConfiguration.Builder()
                    .layer(new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.DenseLayer.Builder()
...
//                int example = i / timeSeriesLength;
                ...
                for (int inputHeight : inputHeights) {
                    for (int inputWidth : inputWidths) {
                        for (int nChannels : numChannels) {
                            ...
                            NeuralNetConfiguration nnc = new NeuralNetConfiguration.Builder()
                                    .layer(new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.ConvolutionLayer.Builder(inputWidth, inputHeight)
    ...
    public void testAutoAdditionOfPreprocessors() {
        ...
        MultiLayerConfiguration conf1 = new NeuralNetConfiguration.Builder()
                .list()
                .layer(0, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.DenseLayer.Builder()
                        .nIn(5).nOut(6).build())
                .layer(1, new GravesLSTM.Builder().nIn(6).nOut(7).build())
                .layer(2, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.DenseLayer.Builder()
                        .nIn(7).nOut(8).build())
        ...
        MultiLayerConfiguration conf2 = new NeuralNetConfiguration.Builder()
                .list()
                .layer(0, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.ConvolutionLayer.Builder()
                        .nOut(10).kernelSize(5, 5).stride(1, 1).build())
                .layer(1, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.DenseLayer.Builder().nOut(6).build())
    ...
    public void testCnnToDense() {
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .regularization(true)
                .list()
                .layer(0, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.ConvolutionLayer.Builder(4, 4) // 28*28*1 => 15*15*10
                        .nIn(1)
                        .nOut(10)
                        .padding(2, 2)
                        .stride(2, 2)
                        ...
                        .activation("relu")
                        .build())
                .layer(1, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.DenseLayer.Builder().activation("relu")
                        .nOut(200).build())
