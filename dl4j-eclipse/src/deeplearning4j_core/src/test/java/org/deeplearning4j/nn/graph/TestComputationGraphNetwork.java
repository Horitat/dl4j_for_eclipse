...
import deeplearning4j_core.src.main.java.org.deeplearning4j.datasets.datavec.RecordReaderMultiDataSetIterator;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.graph.LayerVertex;
...
public class TestComputationGraphNetwork {
    ...
    public void testPreTraining(){
        ComputationGraphConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .addLayer("out", new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.OutputLayer.Builder(LossFunctions.LossFunction.MCXENT)
                        .nIn(3+3).nOut(3)
                        .weightInit(WeightInit.DISTRIBUTION).dist(new UniformDistribution(0, 1))
...
//            System.out.println(score + "\t" + scoreUsingScoreExamples + "\t|\t" + scoreNoReg + "\t" + scoreUsingScoreExamplesNoReg);
    ...
    public void testExternalErrors(){
        ...
        deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.OutputLayer ol = (deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.OutputLayer)s.getLayer(1);
...
//        actualGradient = net.gradient;
    ...
    public void testIterationCountAndPresistence() throws IOException {
        ...
        ComputationGraphConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .addLayer("1", new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.OutputLayer.Builder(LossFunctions.LossFunction.MCXENT).activation("softmax").nIn(3).nOut(3).build(), "0")
                .setOutputs("1")
