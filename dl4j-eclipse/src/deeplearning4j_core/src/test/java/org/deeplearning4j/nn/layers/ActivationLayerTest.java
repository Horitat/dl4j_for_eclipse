...
public class ActivationLayerTest {
    ...
    public void testInputTypes(){
    	deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.ActivationLayer l =
                new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.ActivationLayer.Builder().activation("relu").build();
    ...
    public void testDenseActivationLayer() throws Exception {
        ...
        MultiLayerConfiguration conf2 = new NeuralNetConfiguration.Builder()
                ...
                .layer(1, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.ActivationLayer.Builder().activation("relu").build())
    ...
    public void testAutoEncoderActivationLayer() throws Exception {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .layer(1, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.OutputLayer.Builder(LossFunctions.LossFunction.RECONSTRUCTION_CROSSENTROPY).activation("softmax").nIn(layerSize).nOut(nOut).build())
                .backprop(true).pretrain(false)
                .build();
        ...
        MultiLayerConfiguration conf2 = new NeuralNetConfiguration.Builder()
                ...
                .layer(1, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.ActivationLayer.Builder().activation("sigmoid").build())
                .layer(2, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.OutputLayer.Builder(LossFunctions.LossFunction.RECONSTRUCTION_CROSSENTROPY).activation("softmax").nIn(layerSize).nOut(nOut).build())
                .backprop(true).pretrain(false)
                .build();
