...
public class GravesLSTMTest {
	...
	public void testSingleExample(){
		...
		MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
				...
				.seed(12345)
				.list()
				.layer(0, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesLSTM.Builder().activation("tanh").nIn(2).nOut(2).build())
				.layer(1, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.RnnOutputLayer.Builder().lossFunction(LossFunctions.LossFunction.MSE).nIn(2).nOut(1).activation("tanh").build())
				.build();
	...
	public void testGateActivationFnsSanityCheck(){
		for(String gateAfn : new String[]{"sigmoid", "hardsigmoid"}){
			...
			assertEquals(gateAfn, ((deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesLSTM)net.getLayer(0).conf().getLayer()).getGateActivationFn().toString());
