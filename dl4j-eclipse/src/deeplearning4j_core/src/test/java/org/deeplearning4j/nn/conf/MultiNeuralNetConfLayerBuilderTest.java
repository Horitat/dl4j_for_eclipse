...
public class MultiNeuralNetConfLayerBuilderTest {
    ...
    public void testRbmSetup() throws Exception {
        ...
        deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.api.Layer firstRbm = network.getLayer(0);
        deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.api.Layer secondRbm = network.getLayer(1);
        deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.api.Layer thirdRbm = network.getLayer(2);
        deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.api.Layer fourthRbm = network.getLayer(3);
