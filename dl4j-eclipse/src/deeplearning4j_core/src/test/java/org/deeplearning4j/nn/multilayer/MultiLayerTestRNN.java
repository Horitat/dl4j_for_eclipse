...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.preprocessor.FeedForwardToRnnPreProcessor;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.preprocessor.RnnToFeedForwardPreProcessor;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.recurrent.BaseRecurrentLayer;
...
public class MultiLayerTestRNN {
    ...
    public void testGravesLSTMInit() {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                .list()
                .layer(0, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesLSTM.Builder()
    ...
    public void testGravesTLSTMInitStacked() {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .layer(1, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesLSTM.Builder()
                        .nIn(17).nOut(19).weightInit(WeightInit.DISTRIBUTION).activation("tanh").build())
                .layer(2, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesLSTM.Builder()
    ...
    public void testRnnTimeStepWithPreprocessor() {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .list()
                .layer(0, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesLSTM.Builder().nIn(10).nOut(10).activation("tanh").build())
                .layer(1, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesLSTM.Builder().nIn(10).nOut(10).activation("tanh").build())
    ...
    public void testRnnTimeStepWithPreprocessorGraph() {
        ...
        ComputationGraphConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .graphBuilder()
                .addInputs("in")
                .addLayer("0", new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesLSTM.Builder().nIn(10).nOut(10).activation("tanh").build(), "in")
                .addLayer("1", new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesLSTM.Builder().nIn(10).nOut(10).activation("tanh").build(), "0")
                .addLayer("2", new RnnOutputLayer.Builder(LossFunctions.LossFunction.MCXENT).activation("softmax").nIn(10).nOut(10).build(), "1")
                .setOutputs("2")
                .inputPreProcessor("0", new FeedForwardToRnnPreProcessor())
                .pretrain(false).backprop(true)
                .build();
