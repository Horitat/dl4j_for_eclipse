...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.LearningRatePolicy;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.optimize.api.ConvexOptimizer;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.optimize.solvers.StochasticGradientDescent;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.optimize.stepfunctions.NegativeDefaultStepFunction;
...
public class TestDecayPolicies {
    ...
    deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater[] updaters = {
    		deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater.SGD,
    		deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater.ADAGRAD,
    		deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater.ADAM,
    		deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater.RMSPROP,
    };
    ...
    public void testLearningRateExponentialDecaySingleLayer() {
        ...
        NeuralNetConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .layer(new DenseLayer.Builder()
                        .nIn(nIn).nOut(nOut).updater(deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater.SGD).build())
                .build();
    ...
    public void testLearningRateScheduleSingleLayer() {
        ...
        for (deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater updaterFunc : updaters) {
            double lr = 1e-2;
            NeuralNetConfiguration conf = new NeuralNetConfiguration.Builder()
            ...
            for (int i = 0; i < 2; i++) {
                ...
                if(updaterFunc.equals(deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater.SGD))
                    lr = testSGDComputation(gradientActual, gradientExpected, lr, learningRateAfter, i);
                else if(updaterFunc.equals(deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater.ADAGRAD))
                    lr = testAdaGradComputation(gradientActual, gradientExpected, lr, learningRateAfter, i);
                else if(updaterFunc.equals(deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater.ADAM))
                    lr = testAdamComputation(gradientActual, gradientExpected, lr, learningRateAfter, i);
                else if(updaterFunc.equals(deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater.RMSPROP))
    ...
    public void testLearningRateScoreDecay(){
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .list()
                .layer(0, new DenseLayer.Builder().nIn(nIns[0]).nOut(nOuts[0]).updater(deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater.SGD).build())
                .layer(1, new OutputLayer.Builder().nIn(nIns[1]).nOut(nOuts[1]).updater(deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater.SGD).build())
                .backprop(true).pretrain(false)
                .build();
    ...
    public void testOriginalLearningRateUnchanged() {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .updater(deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater.SGD)
                .seed(12345L)
                .list()
    ...
    public void testMomentumScheduleMLN(){
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .list()
                .layer(0, new DenseLayer.Builder().nIn(nIns[0]).nOut(nOuts[0]).updater(deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater.NESTEROVS).build())
                .layer(1, new OutputLayer.Builder().nIn(nIns[1]).nOut(nOuts[1]).updater(deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater.NESTEROVS).build())
                .backprop(true).pretrain(false)
                .build();
    ...
    public void testUpdatingInConf() throws Exception {
        ...
        for(OptimizationAlgorithm oa : optimizationAlgorithms ) {
            ...
            MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                    ...
                    .updater(deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.Updater.NESTEROVS)
