package deeplearning4j_core.src.test.java.org.deeplearning4j.nn.layers.normalization;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.datasets.iterator.impl.ListDataSetIterator;
...
//        System.out.println(Arrays.toString(p.getSecond().dup().data().asDouble()));
    ...
    public void testGradientAndUpdaters() throws Exception {
        ...
        deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.api.Updater u = net.getUpdater();
        Field f = MultiLayerUpdater.class.getDeclaredField("layerUpdaters");
        f.setAccessible(true);
        deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.api.Updater[] updaters = (deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.api.Updater[]) f.get(u);
