...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.datasets.iterator.IteratorMultiDataSetIterator;
...
public class ComputationGraphTestRNN {
    ...
    public void testRnnTimeStepGravesLSTM() {
        ...
        ComputationGraphConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .graphBuilder()
                .addInputs("in")
                .addLayer("0", new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesLSTM.Builder()
                        .nIn(5).nOut(7).activation("tanh").weightInit(WeightInit.DISTRIBUTION)
                        .dist(new NormalDistribution(0, 0.5)).build(), "in")
                .addLayer("1", new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesLSTM.Builder()
    ...
    public void testRnnTimeStepMultipleInOut() {
        ...
        ComputationGraphConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .graphBuilder()
                .addInputs("in0", "in1")
                .addLayer("lstm0", new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesLSTM.Builder()
                        .nIn(5).nOut(6).activation("tanh").weightInit(WeightInit.DISTRIBUTION)
                        .dist(new NormalDistribution(0, 0.5)).build(), "in0")
                .addLayer("lstm1", new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesLSTM.Builder()
