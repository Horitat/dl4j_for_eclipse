package deeplearning4j_core.src.test.java.org.deeplearning4j.nn.layers.recurrent;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.recurrent.GravesBidirectionalLSTM;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.recurrent.GravesLSTM;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.recurrent.LSTMHelpers;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.multilayer.MultiLayerNetwork;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.params.GravesBidirectionalLSTMParamInitializer;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.params.GravesLSTMParamInitializer;
...
public class GravesBidirectionalLSTMTest {
    ...
    public void testBidirectionalLSTMGravesForwardBasic() {
        ...
        final NeuralNetConfiguration conf = new NeuralNetConfiguration.Builder()
                .layer(new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesBidirectionalLSTM.Builder()
                        .nIn(nIn)
                        .nOut(nHiddenUnits)
                        .activation("tanh")
                        .build())
    ...
    public void testSimpleForwardsAndBackwardsActivation() {
        ...
        final NeuralNetConfiguration confForwards = new NeuralNetConfiguration.Builder()
                .layer(new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesLSTM.Builder()
                        .nIn(nIn).nOut(layerSize)
    ...
    public void testConvergence() {
        ...
        final MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .list()
                .pretrain(false)
                .layer(0, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesBidirectionalLSTM.Builder().activation("tanh").nIn(2).nOut(2)
                        .weightInit(WeightInit.DISTRIBUTION).dist(new UniformDistribution(-0.05, 0.05))
                        .build())
                .layer(1, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesBidirectionalLSTM.Builder().activation("tanh").nIn(2).nOut(2)
                        .weightInit(WeightInit.DISTRIBUTION).dist(new UniformDistribution(-0.05, 0.05))
                        .build())
                ...
                .layer(2, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.RnnOutputLayer.Builder().lossFunction(LossFunctions.LossFunction.MCXENT).nIn(2).nOut(2).activation("tanh").build())
                .backprop(true)
                .build();
    ...
    public void testGateActivationFnsSanityCheck() {
        for (String gateAfn : new String[]{"sigmoid", "hardsigmoid"}) {
            ...
            MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                    ...
                    .seed(12345)
                    .list()
                    .layer(0, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesBidirectionalLSTM.Builder()
                            .gateActivationFunction(gateAfn)
                            .activation("tanh").nIn(2).nOut(2).build())
                    .layer(1, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.RnnOutputLayer.Builder().lossFunction(LossFunctions.LossFunction.MSE)
            ...
            assertEquals(gateAfn, ((deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.GravesBidirectionalLSTM) net.getLayer(0).conf().getLayer()).getGateActivationFn().toString());
