...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.datasets.iterator.ExistingDataSetIterator;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.util.TestDataSetConsumer;
...
public class MultipleEpochsIteratorTest {
    ...
    public void testCifarDataSetIteratorReset() {
        ...
        net.fit(ds);
        assertEquals(epochs, ds.getEpochs());
        assertEquals(2, ds.getBatch());
    }
