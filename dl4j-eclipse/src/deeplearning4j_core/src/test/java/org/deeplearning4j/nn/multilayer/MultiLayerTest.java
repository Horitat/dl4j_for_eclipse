...
package deeplearning4j_core.src.test.java.org.deeplearning4j.nn.multilayer;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.exception.DL4JException;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.BaseOutputLayer;
...
public class MultiLayerTest {
    ...
    public void testBatchNorm() {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .layer(3, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.OutputLayer.Builder(LossFunctions.LossFunction.MCXENT)
    ...
    public void testBackProp() {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .layer(0, new DenseLayer.Builder().nIn(4).nOut(3).weightInit(WeightInit.XAVIER).activation("tanh").build())
                .layer(1, new DenseLayer.Builder().nIn(3).nOut(2).weightInit(WeightInit.XAVIER).activation("tanh").build())
                .layer(2, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.OutputLayer.Builder(LossFunctions.LossFunction.MCXENT)
                        .weightInit(WeightInit.XAVIER)
                        .activation("softmax")
                        .nIn(2).nOut(3).build())
    ...
    public void testDbn() throws Exception {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .layer(1, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.OutputLayer.Builder(LossFunctions.LossFunction.MCXENT)
                        .nIn(3).nOut(3)
                        .weightInit(WeightInit.DISTRIBUTION).dist(new UniformDistribution(0, 1))
...
//        actualGradient = net.gradient;
        ...
        MultiLayerConfiguration rbm = new NeuralNetConfiguration.Builder()
                ...
                .list(
                        new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.RBM.Builder()
                                ...
                                .activation("identity")
                                .nOut(nIn).build(),
                        new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.OutputLayer.Builder(LossFunctions.LossFunction.COSINE_PROXIMITY)
                                .activation("identity")
                                .nOut(nOut).build()
                )
                .pretrain(preTrain)
    ...
    public void testIterationCountAndPresistence() throws IOException {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .list()
                .layer(0, new DenseLayer.Builder().nIn(4).nOut(3).weightInit(WeightInit.XAVIER).activation("tanh").build())
                .layer(1, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.OutputLayer.Builder(LossFunctions.LossFunction.MCXENT).activation("softmax").nIn(3).nOut(3).build())
                .backprop(true).pretrain(false).build();
