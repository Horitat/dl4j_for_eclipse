package deeplearning4j_core.src.test.java.org.deeplearning4j.nn.conf.layers;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.distribution.Distribution;
...
//        assertEquals(1, bN.beta, 1e-4);
    ...
    public void testActivationLayer() throws Exception {
        ...
        //self made
        assertEquals(numIn, activationLayer.getNIn());
        assertEquals(numOut, activationLayer.getNOut());
