package deeplearning4j_core.src.test.java.org.deeplearning4j.nn.layers.variational;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.variational.BernoulliReconstructionDistribution;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.variational.CompositeReconstructionDistribution;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.variational.ExponentialReconstructionDistribution;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.variational.GaussianReconstructionDistribution;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.variational.LossFunctionWrapper;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.variational.ReconstructionDistribution;
...
public class TestVAE {
    ...
    public void testInitialization() {
        ...
        MultiLayerConfiguration mlc = new NeuralNetConfiguration.Builder()
                .list()
                .layer(0, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.variational.VariationalAutoencoder.Builder()
                        .nIn(10).nOut(5).encoderLayerSizes(12).decoderLayerSizes(13).build())
                .build();

        NeuralNetConfiguration c = mlc.getConf(0);
        deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.variational.VariationalAutoencoder vae
        = (deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.variational.VariationalAutoencoder) c.getLayer();
...
//        net.output(in);
    ...
    public void testPretrainSimple(){
        ...
        Map<String,INDArray> paramTable = net.getLayer(0).paramTable();
        Map<String,INDArray> gradTable = ((deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.variational.VariationalAutoencoder)net.getLayer(0)).getGradientViews();
    ...
    public void testParamGradientOrderAndViews() {
        ...
        deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.variational.VariationalAutoencoder layer
        = (deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.variational.VariationalAutoencoder) net.getLayer(0);
...
//            System.out.println(p + "\t" + gv + "\t" + gr);
    ...
    public void testJsonYaml(){
        ...
        MultiLayerConfiguration config = new NeuralNetConfiguration.Builder()
                ...
                .layer(1, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.variational.VariationalAutoencoder.Builder()
                ...
                .layer(2, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.variational.VariationalAutoencoder.Builder()
                ...
                .layer(3, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.variational.VariationalAutoencoder.Builder()
                        .reconstructionDistribution(new ExponentialReconstructionDistribution("tanh"))
                        .nIn(11).nOut(12).encoderLayerSizes(13).decoderLayerSizes(14).build())
                .layer(4, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.variational.VariationalAutoencoder.Builder()
                        //.lossFunction("tanh", LossFunctions.LossFunction.MSE)
                        .lossFunction(new ActivationTanH(), LossFunctions.LossFunction.MSE)
                        .nIn(11).nOut(12).encoderLayerSizes(13).decoderLayerSizes(14).build())
                .layer(5, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.variational.VariationalAutoencoder.Builder()
    ...
    public void testReconstructionDistributionsSimple(){
        ...
        for (int minibatch : new int[]{1, 5}) {
            for (int i = 0; i < reconstructionDistributions.length; i++) {
                ...
                deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.variational.VariationalAutoencoder layer
                = (deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.layers.variational.VariationalAutoencoder) mln.getLayer(0);
