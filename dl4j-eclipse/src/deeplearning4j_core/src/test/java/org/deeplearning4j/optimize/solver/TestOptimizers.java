package deeplearning4j_core.src.test.java.org.deeplearning4j.optimize.solver;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.optimize.solvers.ConjugateGradient;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.optimize.solvers.LBFGS;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.optimize.solvers.LineGradientDescent;
...
public class TestOptimizers {
    ...
    private static void testRosenbrockFnMultipleStepsHelper( OptimizationAlgorithm oa, int nOptIter, int maxNumLineSearchIter ){
        ...
        for( int i = 0; i <= nOptIter; i++ ){
            NeuralNetConfiguration conf = new NeuralNetConfiguration.Builder()
                    .maxNumLineSearchIterations(maxNumLineSearchIter)
                    .iterations(i).stepFunction(new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.stepfunctions.NegativeDefaultStepFunction())
                    .learningRate(1e-1)
                    .layer(new RBM.Builder()
                            .nIn(1).nOut(1)
                            .updater(Updater.SGD)
