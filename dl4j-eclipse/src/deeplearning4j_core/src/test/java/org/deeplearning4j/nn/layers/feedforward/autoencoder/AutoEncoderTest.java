...
package deeplearning4j_core.src.test.java.org.deeplearning4j.nn.layers.feedforward.autoencoder;
...
public class AutoEncoderTest {
    ...
    public void testAutoEncoderBiasInit() {
    	deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.AutoEncoder build = new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.AutoEncoder.Builder()
                .nIn(1)
                .nOut(3)
                .biasInit(1)
                .build();
