...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.optimize.solvers.BackTrackLineSearch;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.optimize.stepfunctions.DefaultStepFunction;
...
public class BackTrackLineSearchTest {
    ...
    private static OutputLayer getIrisLogisticLayerConfig(String activationFunction, int maxIterations, LossFunctions.LossFunction lossFunction){
        NeuralNetConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .layer(new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.OutputLayer.Builder(lossFunction)
                        .nIn(4)
                        .nOut(3)
