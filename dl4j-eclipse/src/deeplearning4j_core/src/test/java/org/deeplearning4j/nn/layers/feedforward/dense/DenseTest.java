package deeplearning4j_core.src.test.java.org.deeplearning4j.nn.layers.feedforward.dense;
    ...
    private static MultiLayerNetwork getDenseMLNConfig(boolean backprop, boolean pretrain) {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .layer(0, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.DenseLayer.Builder()
                        ...
                        .build())
                .layer(1, new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.layers.DenseLayer.Builder()
                        .nIn(3).nOut(2)
                        .activation("tanh")
                        .weightInit(WeightInit.XAVIER)
                        .build())
