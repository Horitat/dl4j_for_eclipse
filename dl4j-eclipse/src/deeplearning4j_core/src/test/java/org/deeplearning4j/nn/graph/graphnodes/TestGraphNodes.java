package deeplearning4j_core.src.test.java.org.deeplearning4j.nn.graph.graphnodes;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.graph.PreprocessorVertex;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.graph.rnn.DuplicateToTimeSeriesVertex;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.graph.rnn.LastTimeStepVertex;
...
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.graph.vertex.impl.L2Vertex;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.graph.vertex.impl.MergeVertex;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.graph.vertex.impl.StackVertex;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.graph.vertex.impl.SubsetVertex;
import deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.graph.vertex.impl.UnstackVertex;
...
public class TestGraphNodes {
    ...
    public void testJSON(){
        ...
        ComputationGraphConfiguration conf = new NeuralNetConfiguration.Builder()
            ...
            .addVertex("v2", new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.graph.MergeVertex(), "in","in")
            .addVertex("v3", new PreprocessorVertex(new CnnToFeedForwardPreProcessor(1,2,1)), "in")
            .addVertex("v4", new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.graph.SubsetVertex(0,1),"in")
            .addVertex("v5", new DuplicateToTimeSeriesVertex("in"),"in")
            .addVertex("v6", new LastTimeStepVertex("in"), "in")
            .addVertex("v7", new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.graph.StackVertex(), "in")
            .addVertex("v8", new deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.conf.graph.UnstackVertex(0,1), "in")
