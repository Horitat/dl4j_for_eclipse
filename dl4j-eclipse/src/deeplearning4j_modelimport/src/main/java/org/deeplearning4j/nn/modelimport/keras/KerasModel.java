...
import deeplearning4j_modelimport.src.main.java.org.deeplearning4j.nn.modelimport.keras.KerasLayer.DimOrder;
import deeplearning4j_modelimport.src.main.java.org.deeplearning4j.nn.modelimport.keras.layers.KerasInput;
import deeplearning4j_modelimport.src.main.java.org.deeplearning4j.nn.modelimport.keras.layers.KerasLoss;
...
public class KerasModel {
     ...
     * @throws InvalidKerasConfigurationException
     */
    protected deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.api.Model helperCopyWeightsToModel(deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.api.Model model)
            throws InvalidKerasConfigurationException {
        /* Get list if layers from model. */
    	deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.api.Layer[] layersFromModel;
        ...
        Set<String> layerNames = new HashSet<String>(this.layers.keySet());
        for (deeplearning4j_nn.src.main.java.org.deeplearning4j.nn.api.Layer layer : layersFromModel) {
